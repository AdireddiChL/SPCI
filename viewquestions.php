...
<html>
<head>
     <title>View Doubts asked by Students </title>
</head>
<style>
  .q { 
    width: 30%;
...
<h1 style="text-align:center;"> Doubts asked by students </h1> 
...
<?php 
      ...
      if($result->num_rows>0){
          ...
          if($result_1->num_rows>0){
              while($row_1 = $result_1->fetch_assoc()) {
                  ...
                  <?php  echo "Course name:   " .$row["coursename"] ."<br><br>";
                      ...
                      echo "Doubt:  " .$row_1["Doubtquestion"] ."<br><br><br><br>"; 
         ...
         <?php }
          ...
          <h2 style="text-align:center;"> Clarify Doubt <a href="clarifydoubt.php">Clarify<a> </h2> 
          <h3 style="text-align:center;"> Dont want to Clarify ? move to <a href="welcomeprof.php">Home<a> </h3> 
