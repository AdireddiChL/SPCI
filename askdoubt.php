...
<body>
    <div class="header">
      <h2>Ask Doubt :<?php echo $_SESSION["username"] ?></h2>
    </div>
     
    <form method="post" action="askdoubt.php">
    <div class="input-group">
        ...
        <div class="input-group">
            ...
            <textarea type="text" name="question" rows="10" cols="50" required></textarea>
       </div>
       ...
       <p>
          Don't want to ask doubt? Back to<a href="yourcoursesstu.php"> your courses</a>
       </p> 
   </form>
           ...
           require_once "db.php";
                 ...
                 if(isset($_POST['submit'])){
                    ...
                    if($result->num_rows==1){
                        ...
                        $sql_1 = "UPDATE student SET Doubtquestion='$question' WHERE coursenamestu = '$coursenamestu' AND stusername='$stusername'";
                       $result = $mysqli->query($sql_1);
                if ($result) {
                    
                    echo "<script>alert('Doubt asked successfully');document.location.href='yourcoursesstu.php';</script>";
                }
                else {?>
