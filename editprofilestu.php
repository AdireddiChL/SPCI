...
<html>
<head>
     <title>Edit profile for student</title>
    ...
    <?php
                 ...
                 if(isset($_POST['submit'])){
                    ...
                    if(strcmp($username,$_SESSION["username"])){
                        $check_user = "SELECT username FROM userstudent WHERE username = '$username'";
                    ...
                    if(empty($user_err)){
                    $sql= "UPDATE  userstudent SET username= '$username', mobileno='$mobilenumber',password='$passwordhash' 
                        WHERE  id ='$id'";
                    ...
                    if(mysqli_query($mysqli,$sql))
                    {
                      ...
                      echo "<script>alert('Succesfully Edited');document.location.href='welcomestu.php';</script>";
                    }
